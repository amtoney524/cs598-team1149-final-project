'''
Code taken from: https://github.com/iliasprc/COVIDNet.git

Source: https://github.com/iliasprc/COVIDNet/blob/master/model/model.py

Author: Ilias Papastratis (https://github.com/iliasprc)
...
class CovidNetLSTM(nn.Module):
    def __init__(self, model='small', n_classes=3):
        super(CovidNetLSTM, self).__init__()
        filters = {
            'pexp1_1': [64, 256],
            'pexp1_2': [256, 256],
            'pexp1_3': [256, 256],
        ...
        self.add_module('reshape', Reshape())
        self.add_module('lstm', nn.LSTM(7 * 7, 7 * 7, batch_first=True))
